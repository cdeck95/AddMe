...
struct SwpingCarouselCellManager {
    ...
    fileprivate struct Constants {
        static let SwipeDistanceToTakeAction: CGFloat  = UIScreen.main.bounds.size.height / 6 //Distance required for the cell to go off the screen.
    ...
    func afterSwipeAction() {
        ...
        //if (cell.frame.size.height > cell.bounds.size.height) {
            ...
            print("Swipe distance on y: \(swipeDistanceOnY)")
            print("Swipe distance to take action: \(Constants.SwipeDistanceToTakeAction)")
